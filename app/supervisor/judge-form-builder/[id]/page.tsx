...
export default function SupervisorJudgeFormBuilderPage() {
  ...
  // Form Settings
  const [formTitle, setFormTitle] = useState('طلب الانضمام كمحكم')
  const [formDescription, setFormDescription] = useState('املأ النموذج للتقديم كمحكم في الهاكاثون')
  ...
  const handleSave = async () => {
    setSaving(true)
    try {
      const response = await fetch(`/api/admin/judge-form/${hackathonId}`, {
        method: 'POST',
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-3">
              <Button
                variant="outline"
                onClick={() => window.open(`/judge/apply/${hackathonId}`, '_blank')}
          ...
          <TabsContent value="fields">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  أضف وعدل الحقول التي تريدها في فورم المحكمين
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="طلب الانضمام كمحكم"
                    className="mt-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="نرحب بانضمامك كمحكم..."
                    rows={3}
                    className="mt-2"
                  />
                </div>

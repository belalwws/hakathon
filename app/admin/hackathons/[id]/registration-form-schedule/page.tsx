...
export default function HackathonFormSchedulePage({ params }: { params: { id: string } }) {
  const { user } = useAuth()
  ...
  const fetchFormSchedule = async () => {
    try {
      const response = await fetch(`/api/admin/hackathons/${params.id}/registration-form-schedule`)
      if (response.ok) {
      ...
      <div className="flex items-center justify-center min-h-screen">
        <Card className="max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-2">لا يوجد فورم</h2>
            <p className="text-gray-600 mb-4">يرجى إنشاء فورم التسجيل أولاً</p>
            <Link href={`/admin/hackathons/${params.id}/registration-form`}>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            تحديد موعد فتح وإغلاق فورم تسجيل المشاركين
          </p>
        </motion.div>
              ...
              <div className="flex items-center justify-between">
                ...
                {status && (
                  <div className={`px-4 py-2 rounded-full font-semibold flex items-center gap-2 ${
                    ...
                    status.status === 'pending' ? 'bg-blue-100 text-blue-700' :
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    حدد موعد فتح وإغلاق استقبال التسجيلات
                  </CardDescription>
                </div>
              ...
              {!enableSchedule && (
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-blue-700 font-medium">
                    الجدولة معطلة - فورم التسجيل متاح دائماً
                  </p>
                ...
                <>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-green-800">موعد فتح التسجيل</h3>
                        <p className="text-green-600 text-sm">متى سيصبح التسجيل متاحاً</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-red-800">موعد إغلاق التسجيل</h3>
                        <p className="text-red-600 text-sm">متى سيتم إيقاف استقبال التسجيلات</p>
                      </div>
                    </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-2 text-blue-800">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>عند تفعيل الجدولة، سيرى المشاركون عداد تنازلي قبل فتح التسجيل</li>
                    <li>بعد موعد الإغلاق، سيتم عرض رسالة أن التسجيل مغلق</li>
                    <li>يمكنك تعديل الأوقات في أي وقت حتى بعد النشر</li>
                    <li>إذا لم تحدد موعد فتح، سيكون التسجيل متاحاً فوراً</li>
                    <li>إذا لم تحدد موعد إغلاق، سيبقى التسجيل مفتوحاً للأبد</li>
                  </ul>
                </div>
              </div>
            </CardContent>

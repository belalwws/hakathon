...
// GET - Get expert form configuration
...
// POST - Save expert form configuration
export async function POST(
  ...
  try {
    ...
    // Upsert form design
    const form = await prisma.expertFormDesign.upsert({
      where: { hackathonId },
      create: {
        hackathonId,
        isEnabled: true,
        title: title || 'طلب الانضمام كخبير',
    ...
    console.error('Error saving expert form:', error)
    return NextResponse.json(
